...
{{/*
Return the proper MinIO(R) ingress host
*/}}
{{- define "fluentd.aggregator.ingressHost" -}}
{{- if .Values.global }}
    {{- if .Values.global.innerHost }}
     {{- printf "fluentd.%s" .Values.global.innerHost -}}
    {{- end -}}
{{- else }}
{{- printf "%s" .Values.aggregator.ingress.hostname -}}
{{- end -}}
{{- end -}}
